...
// This defines the callback function which will be called by debugAjax()
// It will accept response as a parameter, which is an object that will be 
// given data by debugAjax through a fetch request for a geojson file
// stringify function converts response object containing the geojson data into a string 
function debugCallback(response){
	document.querySelector("#myDiv").insertAdjacentHTML('beforeend', 'GeoJSON data: ' + JSON.stringify(response))
};


// performs fetch request to get data from the geojson
// returns response object to be used by debugCallback()
function debugAjax(){
...
// // alternative to event listener for calling initialize function
